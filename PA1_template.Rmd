...
```
The `mean` of steps per day is `r step_mean` and the `median` of steps per day is `r step_median`.
...
The 5-minute interval, on average across all the days in the data set, with the maximum number of steps is interval `r max_interval`.
...
```
        * The number of missing cases in the data is `r incomplete_count`
...
```
* The imputed data mean is `r step_mean_impute`
* The imputed data median is `r step_median_impute`
...
```
* The difference between the non-imputed mean and imputed mean is `r step_mean_diff`
* The difference between the non-imputed median and imputed median is `r step_median_diff`
* The difference between total number of steps between imputed and non-imputed data is `r step_sum_diff`. 
6. What is the impact of imputing missing data on the estimates of the total daily number of steps?
* As a result, there are `r step_sum_diff` more steps in the imputed data and the median has shifted
by `r step_median_diff`
